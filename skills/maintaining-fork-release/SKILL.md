...
5. The whole shipped `pr-preflight` skill, explicit authority to use its `task` tool for its own fresh-context reviewer and gate runners, and the **per-PR** scratch path.
