...
knives start BRANCH            claim (waiting up to a minute for the claim lock; a refusal names the holder), create the workspace, base it on the release's shared base (falling back to fetched trunk)
